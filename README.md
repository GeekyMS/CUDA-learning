...
Built as a recruiting artifact targeting NVIDIA HPC/compiler internships (Summer 2027).
Each project shows the full optimization journey: naive → cache-aware → GPU-accelerated.
...
| Project | Problem Size | CPU Baseline | GPU Best | Speedup |
|---------|-------------|--------------|----------|---------|
| 01 Matmul | N=1024 | — | — | — |
| 02 Prefix Scan | N=1M | — | — | — |
